...
#### MNIST 
> python main_lg.py --dataset mnist --model mlp --num_classes 10 --epochs 100 --lr 0.05 --num_users 100 --shard_per_user 2 --frac 0.1 --local_ep 1 --local_bs 10 --num_layers_keep 3 --results_save run1 --load_fed best_400.pt
